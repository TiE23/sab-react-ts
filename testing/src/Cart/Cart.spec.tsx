...
describe("Cart", () => {
  ...
  describe("with products", () => {
    // Oh, wait. You do define an array like this!
    ...
    it("renders cart products list with total price", () => {
      ...
      expect(container.innerHTML).toMatch("Product foo 100 /image/foo_source.png");
      expect(container.innerHTML).toMatch("Product bar 100 /image/bar_source.png");
